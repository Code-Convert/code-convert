    ...
    <footer className="relative z-10 border-t border-white/3 pt-8 md:pt-16 pb-6 md:pb-10 bg-[#050505]/80 backdrop-blur-md overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6">
          ...
          <a href="/contact" className="px-4 py-2 rounded-full border border-white/5 bg-white/2 hover:bg-white/6 hover:border-white/10 transition-all text-[10px] font-bold tracking-widest uppercase text-neutral-400 flex items-center gap-1.5 group w-full md:w-auto justify-center md:justify-start">
