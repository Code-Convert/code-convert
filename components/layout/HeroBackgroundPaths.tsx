        ...
        <div className="relative min-h-screen w-full flex flex-col overflow-hidden bg-black">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 pt-20 sm:pt-24 md:pt-32 pb-10 sm:pb-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl mx-auto">
                    ...
                    >
                        <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-2xl border border-white/10 overflow-hidden bg-black/20 backdrop-blur-sm hidden lg:block">
                            <img
                                src={imageSrc}
                                alt={imageAlt}
