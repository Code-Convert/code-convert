...
export default function ContactUs() {
  const { isFocusMode, activate, deactivate } = useFocusMode();
      ...
      <LayoutGroup id="onboarding">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start align-center">
            ...
            {/* Right Column - Form */}
            <div>
              <OnboardingForm isFocusMode={isFocusMode} onActivateFocus={activate} onDeactivateFocus={deactivate} sourcePage="contact-us" />
            </div>
          </div>
        </div>
      </LayoutGroup>
